...
const UserManagement = () => {
  ...
  const fetchData = async () => {
    ...
    const [profilesResult, registrationsResult, verificationsResult] = await Promise.all([
      ...
      supabase.from("identity_verification_requests").select("*")
    ]);
    ...
    if (verificationsResult.data) setVerificationRequests(verificationsResult.data as VerificationRequest[]);
